...
_0x3:
	.DB  0x20,0x20,0x20,0x52,0x65,0x7A,0x61,0x20
	.DB  0x53,0x61,0x62,0x7A,0x69,0x20,0x20,0x20
	.DB  0x0
_0x0:
	.DB  0x3E,0x0,0x5F,0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 0023 char str[17] = "   Reza Sabzi   ";
; 0000 0024 int i,j;
...
; 0000 008E // RS - PORTD Bit 0
; 0000 008F // RD - PORTD Bit 1
; 0000 0090 // EN - PORTD Bit 2
; 0000 0091 // D4 - PORTD Bit 4
; 0000 0092 // D5 - PORTD Bit 5
; 0000 0093 // D6 - PORTD Bit 6
; 0000 0094 // D7 - PORTD Bit 7
; 0000 0095 // Characters/line: 16
; 0000 0096 lcd_init(16*2);
	LDI  R26,LOW(32)
	RCALL _lcd_init
; 0000 0097 
; 0000 0098 while (1)
...
; 0000 009B         lcd_puts(str);
	MOVW R26,R28
	RCALL _lcd_puts
; 0000 009C         for(i = 16; i >= 0 ; i--){
	__GETWRN 16,17,16
_0x8:
	TST  R17
	BRMI _0x9
; 0000 009D             lcd_gotoxy(i,0);
	ST   -Y,R16
	LDI  R26,LOW(0)
	RCALL _lcd_gotoxy
; 0000 009E             if(i % 2 == 0){
...
; 0000 00A4             lcd_clear();
	RCALL _lcd_clear
; 0000 00A5             for(j = 0; j < i ; j++){
	__GETWRN 18,19,0
_0xD:
	__CPWRR 18,19,16,17
	BRGE _0xE
; 0000 00A6                 lcd_putchar(str[j]);
	MOVW R26,R28
	ADD  R26,R18
	ADC  R27,R19
	LD   R26,X
